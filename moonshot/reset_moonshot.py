...
def parse_args():
    ...
    # TODO: support just c1 or 1 (we only have n1, so we can assume the rest)
...
def main():
    ...
    # TODO: use color library or similar
    print("\033[92mReboot command sent successfully.\033[0m")
